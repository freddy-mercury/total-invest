	...
	<td class="content">
		...
		<div class="page_name">
			{t}Account information{/t}
				...
				<table width="100%">
					<tr>
						<td width="50%">
							...
							<p><b>{t}Referral link{/t}:</b> <a href="https://{$smarty.server.HTTP_HOST}/?referral={$user.login}" class="blue">https://{$smarty.server.HTTP_HOST}/?referral={$user.login}</a></p>
						</td>
						<td>
				...
				<p><b>HTML {t}Code{/t}:</b></p>
				<p><img src="/themes/{get_setting name='theme'}/images/468x60.gif" style="border:1px solid #cccccc"></p>
				<p><textarea style="width:400px;height:50px;"><a href="http://{$smarty.server.HTTP_HOST}/?referral={$user.login}"><img src="http://{$smarty.server.HTTP_HOST}/themes/{get_setting name='theme'}/images/468x60.gif" border="0"></a></textarea></p>
				<p><b>BB {t}Code{/t}:</b></p>
				<p><textarea style="width:400px;height:50px;">[url=http://{$smarty.server.HTTP_HOST}/?referral={$user.login}][img]http://{$smarty.server.HTTP_HOST}/themes/{get_setting name='theme'}/images/468x60.gif[/img][/url]</textarea></p>
		</div>
	</td>
