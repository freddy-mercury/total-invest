...
<div class="page_name">
			...
			<table cellpadding="3" cellspacing="1" align="center">
				...
				<tr>
					...
					<td id="td_login"><input type="text" name="login" id="the_login" value="{$signup.login}" autocomplete="off" onchange="this.style.border='auto'" onkeyup="Signup.CheckLogin(this)">
					<span id="span_login"></span></td>
